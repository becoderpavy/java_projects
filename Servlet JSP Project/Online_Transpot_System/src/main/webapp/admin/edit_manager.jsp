		...
		<div class="row">
			<div class="col-md-6 ">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Edit Manager</p>
						...
						%>
						<form id="userRegister" class="row g-3" action="../updateManager"
							method="post">
							<input type="hidden" name="id" value="<%=u.getId()%>">
							<div class="col-12">
								<label class="form-label">Full Name</label> <input type="text"
									value="<%=u.getFullName()%>" required name="fullName"
									class="form-control form-control-sm">
							</div>
							<div class="col-12">
								<label class="form-label">Username</label> <input type="text"
									value="<%=u.getUserName()%>" required name="userName"
									class="form-control form-control-sm">
							</div>
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<label for="inputState" class="form-label">Location</label> <select
									...
									<option value="<%=u.getLocation()%>"><%=u.getLocation()%></option>
								...
								<button class="btn bg-custom text-white col-md-12 mt-3">Update</button>
							</div>
