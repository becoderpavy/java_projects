	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active" ><a class="nav-link" href="index.jsp">Register</a></li>
				</li>
			</ul>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="RegisterServlet" method="post">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">DOB</label> <input type="date" name="dob"
									class="form-control" id="exampleInputEmail1"
									aria-describedby="emailHelp" placeholder="Enter email"  class="text-success text-center">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Phone NO</label> <input name="phno"
