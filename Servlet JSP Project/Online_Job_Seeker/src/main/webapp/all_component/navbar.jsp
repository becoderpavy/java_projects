				...
				<div class="row">
					<div class="btn-group">
						<button type="button" class="btn btn-primary dropdown-toggle"
							...
							<i class="fas fa-user-circle"></i> ${userObj.firstName }
						</button>
						<div class="dropdown-menu">
							...
							<!-- <a class="dropdown-item" href="password.jsp">Change Password</a> -->
							 <a class="dropdown-item" href="add_resume.jsp">Add Resume</a>
							  <a class="dropdown-item" href="view_resume.jsp">View Resume</a>
							  <a class="dropdown-item" href="apply_job.jsp">Applied Jobs</a>
							  
							<div class="dropdown-divider"></div>
						</div>
					</div>
					<a href="userLogout" class="btn btn-outline-primary ml-2"><i
