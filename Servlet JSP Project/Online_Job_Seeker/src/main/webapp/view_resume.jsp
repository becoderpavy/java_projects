...
<body>
	...
	Resume r = dao.getResumeByUserId(u.getId());
	%>
	<div class="container">
		<div class="row">
				...
				<div class="card card-shodow">
					<div class="card-body">
						<div class="text-right">
							<a href="edit_resume.jsp?id=<%=r.getId()%>"
								class="btn btn-sm btn-primary">Edit</a> <a
								href="deleteResume?id=<%=r.getId()%>"
						...
						<form action="addResume" enctype="multipart/form-data"
							...
							<table class="table borderless">
								...
								<tr class="p-3">
									...
									<td class="font-weight-bold">:</td>
									<td><a href="downloadFile?fileName=<%=r.getResumeFileName()%>"
