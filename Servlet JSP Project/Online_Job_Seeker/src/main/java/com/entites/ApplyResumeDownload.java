...
@WebServlet(description = "Download File From The Server", urlPatterns = { "/apdownloadFile" })
public class ApplyResumeDownload extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public static int BUFFER_SIZE = 1024 * 100;
	public static final String UPLOAD_DIR = "apply_resume";
