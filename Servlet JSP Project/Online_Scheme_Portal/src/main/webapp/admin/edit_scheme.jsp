		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<p class="text-center fs-3">Edit Scheme</p>
					...
					Scheme sc = dao.getSchemeById(id);
					%>
					<div class="card-body">
						<form action="../updateScheme" method="post"
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Scheme
									Name </label> <input value="<%=sc.getSchemeName()%>" type="text"
							...
							<div class="mb-3">
								...
								<textarea rows="3" cols="" name="description" required
									class="form-control"><%=sc.getDescription()%></textarea>
							</div>

							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Official
									Site </label> <input value="<%=sc.getSiteLink()%>" name="siteLink"
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Published
									Date </label> <input value="<%=sc.getPublishDate()%>"
									name="publishDate" type="date" class="form-control" required
									id="exampleInputEmail1" aria-describedby="emailHelp">
							</div>
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Uplpad
									...
									id="exampleInputEmail1" aria-describedby="emailHelp"> <small>upload
									File: <%=sc.getFileName()%></small>
							</div>
