				...
				<div class="card-body">
					<div class="row">
								...
								<div class="card-body">
									...
									<form action="../addbook" method="post"
										...
										<div class="form-group">
											...
											<textarea rows="3" cols="" class="form-control" name="desc"></textarea>
										</div>

										<button class="btn btn-block btn-success">Add Books</button>
						...
						<div class="col-md-6 text-center p-5">
							<img alt="" src="../img/bk.png" width="300px" height="300px">
						</div>
					</div>
				</div>
			</div>
