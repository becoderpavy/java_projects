			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						Orphans p = dao.getPatientById(id);
						%>
						<div class="row">
							<div class="col-md-4 ">
								<img src="../orphans_img/<%=p.getImage()%>" width="400"
									height="450">
							</div>
								...
								<form action="add_user" method="post"
									...
									<div class="form-group">
										<label>Document &nbsp &nbsp</label> <a
											href="../Ofiledownload?fn=<%=p.getDocument()%>"
