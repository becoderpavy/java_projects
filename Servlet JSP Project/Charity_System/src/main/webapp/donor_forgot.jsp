...
<body style="background-color: #f0f1f2;">
		...
		<div class="row">
			<div class="col-md-6 offset-md-3 p-5">
				<div class="card paint-card">
					<div class="card-body">
						<h4 class="text-center">Donor Forgot Password</h4>
	...
	if (email != null && phno != null) {
		...
		if (dao.checkPasswordAuthen(email, phno)) {
			response.sendRedirect("donor_changepassword.jsp?email=" + email + "&&phno=" + phno);

		} else {
			session.setAttribute("failedMsg", "invalid details");
			response.sendRedirect("donor_forgot.jsp");
		}
	}
	%>
