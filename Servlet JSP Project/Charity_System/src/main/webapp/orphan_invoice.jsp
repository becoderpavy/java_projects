...
<%@page import="com.admin.servlet.OrphanDonateStatus"%>
				...
				<div class="card">
					<div class="card-body">
						...
						DonateOrphanDAO dao = new DonateOrphanDAO(DBConnect.getConn());
						 DonateOrphan d = dao.getDonateById(id);
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td class="p-5">Pay to : <%=p.getName()%> <br>
										Problem : <%=p.getProblem()%><br> Category : <%=p.getCategory()%>
