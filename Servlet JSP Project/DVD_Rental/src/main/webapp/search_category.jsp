<%@page import="com.entites.FilmCategory"%>
...
<body>
	...
	<div class="container p-4">
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<%
				String ch = request.getParameter("cat");
				FilmDAO dao = new FilmDAO(DBConnect.getConnection());
				int id = dao.getCategoryId(ch);

				List<FilmCategory> list2 = dao.getFilmId(id);
				%>
				<p class="fs-4">
					Search Results for
					<%=ch%></p>
				<div class="card paint-card">
					<div class="card-body">
						...
						<table class="table">
							...
							<tbody>
								<%
								for (FilmCategory fi : list2) {

									Film f = dao.getFilmById(fi.getFilmId());
								%>
