...
import com.railway.util.SecurityUtil;
...
public class JwtProviderImpl implements JwtProvider {
	...
	public Authentication getAuthentication(HttpServletRequest request) {
		...
		UserDetails userDetails = CustomUserDetails.builder().userName(username)
				.authorities(Arrays.asList(simpleGrantedAuthority)).id(userid).build();

		if (username == null) {
			return null;
		}
		return new UsernamePasswordAuthenticationToken(userDetails, "", Arrays.asList(simpleGrantedAuthority));
	}
