...
public class FileController {
	...
	@GetMapping(value = "/cat/{imgName}", produces = MediaType.IMAGE_JPEG_VALUE)
	public void downloadCatFile(@PathVariable String imgName, HttpServletResponse response) throws IOException {

		InputStream resource = fileService.getResource(catPath, imgName);
		response.setContentType(MediaType.IMAGE_JPEG_VALUE);
		StreamUtils.copy(resource, response.getOutputStream());
